...
public class FragA extends Fragment implements TextWatcher {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        for (Button b : mOperands.values()) {
            b.setEnabled(false);        //  disable buttons as default.
        ...
        // assigning text listeners to TextViews
        mFirstText.addTextChangedListener(this); // allow assigning: this - becasue this classs implements the method.
        mSecondText.addTextChangedListener(this); // allow assigning: this - becasue this classs implements the method.
    }
