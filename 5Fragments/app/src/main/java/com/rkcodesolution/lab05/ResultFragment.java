...
import static com.rkcodesolution.lab05.MainActivity.MYTAG;

public class ResultFragment extends Fragment implements SeekBar.OnSeekBarChangeListener {
     ...
     */
    public void calculate(String op1Str, String op2Str, int operand) {
        try {
