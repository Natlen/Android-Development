...
public class CountryXMLParser {
	...
	public static ArrayList<Country> parseCountries(Context context, Set<String> ignoredCountries){
			...
			while (eventType != XmlPullParser.END_DOCUMENT){
				...
				switch (eventType){
					...
					case XmlPullParser.END_TAG:
						if (inTag.equalsIgnoreCase(KEY_COUNTRY)) {
							if (ignoredCountries == null ||
									!ignoredCountries.contains(currentCountry.name)) {
